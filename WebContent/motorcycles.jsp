...
<%
    ...
    if (products != null && !products.isEmpty()) {
        for (Product p : products) {
            if ("Sport".equalsIgnoreCase(p.getCategory())) {
                sportProducts.add(p);
            }
        }
    }
...
<head>
    ...
    <title>E-Commerce - Sport Products</title>
</head>
<body>
    ...
    <div class="container">
        <div class="card-header my-3 text-center bg-dark text-primary">Motorcycles</div>
        <div class="row">
            <%
            ...
            <%
                    ...
                    out.println("There are no products available in the Sport category.");
                }
            %>
        </div>
    </div>
    ...
    <style>
        ...
        .banner1 {
        background: url('https://shop.yamaha-motor-india.com/cdn/shop/collections/motorcycles_1400x_55644dda-7b19-423c-86da-f81749619a66_1800x.png?v=1712576459') no-repeat center center;
