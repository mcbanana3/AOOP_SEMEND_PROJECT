...
<%
    ...
    if (products != null && !products.isEmpty()) {
        for (Product p : products) {
            if ("Scooter".equalsIgnoreCase(p.getCategory())) {
                sportProducts.add(p);
            }
        }
    }
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <%
                    ...
                    out.println("There are no products available in the Scooter category.");
                }
            %>
        </div>
    </div>
    ...
    <style>
        ...
        .banner1 {
        background: url('https://shop.yamaha-motor-india.com/cdn/shop/collections/Scooters_1400x_8010b55b-4014-4530-a95a-b1dd76381bc8_1800x.png?v=1676871095') no-repeat center center;
